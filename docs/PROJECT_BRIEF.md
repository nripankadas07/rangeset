        ...
        rangeset exists to solve a narrow, inspectable developer-tooling problem:
        Manage non-overlapping integer ranges with merge, intersection, and complement. Zero dependencies.
        ...
        Topics: data-structures, interval, python, range, set-operations, zero-dependencies
